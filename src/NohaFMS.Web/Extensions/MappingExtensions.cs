...
using NohaFMS.Core.Infrastructure.Mapper;
using NohaFMS.Core.Reflection;
using NohaFMS.Core.Timing.Utils;
...
namespace NohaFMS.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        #region Cycle
        public static CycleModel ToModel(this Core.Domain.Cycle entity)
        {
            return entity.MapTo<Core.Domain.Cycle, CycleModel>();
        }
        public static Cycle ToEntity(this CycleModel model, Cycle cycle)
        {
            return model.MapTo<CycleModel, Cycle>(cycle);
        }
        #endregion

        #region PasswordPolicy
        public static PasswordPolicyModel ToModel(this Core.Domain.PasswordPolicy entity)
        {
            return entity.MapTo<Core.Domain.PasswordPolicy, PasswordPolicyModel>();
        }
        public static PasswordPolicy ToEntity(this PasswordPolicyModel model, PasswordPolicy passwordPolicy)
        {
            return model.MapTo<PasswordPolicyModel, PasswordPolicy>(passwordPolicy);
        }
        #endregion
        
        #region City
        public static CityModel ToModel(this Core.Domain.City entity)
        {
            return entity.MapTo<Core.Domain.City, CityModel>();
        }
        public static City ToEntity(this CityModel model, City city)
        {
            return model.MapTo<CityModel, City>(city);
        }
        #endregion
        
        #region Hub
        public static HubModel ToModel(this Core.Domain.Hub entity)
        {
            return entity.MapTo<Core.Domain.Hub, HubModel>();
        }
        public static Hub ToEntity(this HubModel model, Hub hub)
        {
            return model.MapTo<HubModel, Hub>(hub);
        }
        #endregion


        #region Bank
        public static BankModel ToModel(this Core.Domain.Bank entity)
        {
            return entity.MapTo<Core.Domain.Bank, BankModel>();
        }
        public static Bank ToEntity(this BankModel model, Bank bank)
        {
            return model.MapTo<BankModel, Bank>(bank);
        }
        #endregion

        #region Branch
        public static BranchModel ToModel(this Core.Domain.Branch entity)
        {
            return entity.MapTo<Core.Domain.Branch, BranchModel>();
        }
        public static ReturnReasonModel ToModel(this Core.Domain.ReturnReason entity)
        {
            return entity.MapTo<Core.Domain.ReturnReason, ReturnReasonModel>();
        }
        public static ReturnReason ToEntity(this ReturnReasonModel model, ReturnReason returnreason)
        {
            return model.MapTo<ReturnReasonModel, ReturnReason>(returnreason);
        }
        public static Branch ToEntity(this BranchModel model, Branch branch)
        {
            return model.MapTo<BranchModel, Branch>(branch);
        }
        #endregion
        ...
        public static BranchModel ToModelBranch(this Branch entity)
        {
            return entity.MapTo<Branch, BranchModel>();
        }
        ...
        #region ChequeDepositInformation




        public static ChequeDepositModel ToModel(this ChequeDepositInformation entity)
        {
            return entity.MapTo<ChequeDepositInformation, ChequeDepositModel>();
        }


        public static ChequeDepositInformation ToEntity(this ChequeDepositModel model)
        {
            return model.MapTo<ChequeDepositModel, ChequeDepositInformation>();
        }

        public static ChequeDepositInformation ToEntity(this ChequeDepositModel model, ChequeDepositInformation destination)
        {
            return model.MapTo(destination);
        }
        ...
        public static LiveMonitoringModel ToModel(this LiveMonitoring entity)
        {
            return entity.MapTo<LiveMonitoring, LiveMonitoringModel>();
        }


        public static LiveMonitoring ToEntity(this LiveMonitoringModel model)
        {
            return model.MapTo<LiveMonitoringModel, LiveMonitoring>();
        }

        public static LiveMonitoring ToEntity(this LiveMonitoringModel model, LiveMonitoring destination)
        {
            return model.MapTo(destination);
        }
