...
namespace NohaFMS.Web.Controllers
{
    public class CommonController : BaseController
    {
        ...
        public ActionResult SystemInfo()
        {
            ...
            model.BaseEamVersion = NohaFMSVersion.CurrentVersion;
       ...
       public JsonResult Returnreasone()
        {
            var status = new List<SelectListItem>();
            status.Add(new SelectListItem()
            {
                Text = "Insufficient funds in drawer’s account",
                Value = "Insufficient funds in drawer’s account",

            });           

            status.Add(new SelectListItem()
            {
                Text = "Date is Missing / Invalid",
                Value = "Date is Missing / Invalid",

            });
            status.Add(new SelectListItem()
            {
                Text = "Closed / Inactive Account",
                Value = "Closed / Inactive Account",

            });
            status.Add(new SelectListItem()
            {
                Text = "Bank’s special crossing required",
                Value = "Bank’s special crossing required",

            });
            status.Add(new SelectListItem()
            {
                Text = "Payment stopped by drawer",
                Value = "Payment stopped by drawer",

            });
            status.Add(new SelectListItem()
            {
                Text = "Alteration on payment instrument requires drawer's signature",
                Value = "Alteration on payment instrument requires drawer's signature",

            });
            status.Add(new SelectListItem()
            {
                Text = "Signature is unauthorized / differ from specimen on record",
                Value = "Signature is unauthorized / differ from specimen on record",

            });
            status.Add(new SelectListItem()
            {
                Text = "Payment defer for physical instrument review",
                Value = "Payment defer for physical instrument review",

            });

            status.Add(new SelectListItem()
            {
                Text = "Duplicate instrument / Instrument lodged again in Clearing",
                Value = "Duplicate instrument / Instrument lodged again in Clearing",

            });
            status.Add(new SelectListItem()
            {
                Text = "Ammount in word and figure differs",
                Value = "Ammount in word and figure differs",
        ...
        {
            var Error = new List<SelectListItem>();
            Error.Add(new SelectListItem()
            {
                Text = "False",
                Value = "False",
