    ...
    public class ReportController : BaseController
    {
        ...
        public ActionResult List(DataSourceRequest command, string searchValues, IEnumerable<Sort> sort = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    Data = data.reports.OrderByDescending(x=>x.Id),
                    //.Select(x => x.ToModel()),
        ...
        //[HttpPost]
        //[BaseEamAuthorize(PermissionNames = "Report.Report.Read")]
        //public ActionResult MyReportList(DataSourceRequest command, string searchValues, IEnumerable<Sort> sort = null)
        //{
        //    //User activity log
        //    _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl, "My Report List");
        //    var model = _httpContext.Session[SessionKey.ReportSearchModel] as SearchModel;
        //    if (model == null)
        //        //model = BuildSearchModel2();
        //    else
        ...
        //        PagedResult<MyReport> data = _reportService.GetMyReports(model.ToExpression(), model.ToParameters(), command.Page - 1, command.PageSize, sort);
