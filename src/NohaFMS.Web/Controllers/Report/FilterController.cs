...
namespace NohaFMS.Web.Controllers
{
    public class FilterController : BaseController
    {
        ...
        {
            _filterService.ReportActivityFlowlog(_workContext.CurrentUser.Id,"User["+_workContext.CurrentUser.Name+"] Report Filter List");
            _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl, "Report Filter");
            var model = _httpContext.Session[SessionKey.FilterSearchModel] as SearchModel;
            if (model == null)
                model = BuildSearchModel();
            else
