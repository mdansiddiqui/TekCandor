...
namespace NohaFMS.Web.Controllers
{
    public class DashboardController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //_visualService.VisualActivityFlowlog(_workContext.CurrentUser.Id, "User["+ _workContext.CurrentUser.Name+ "] Dashboard");
            _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl, "Dashboard");
            return View(model);
        }
