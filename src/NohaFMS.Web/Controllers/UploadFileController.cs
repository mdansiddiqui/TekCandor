...
using NohaFMS.Web.Framework.Security;
using System;
...
namespace NohaFMS.Web.Controllers
{
    public class UploadFileController : BaseController
    {
        ...
        public bool WriteToFile(Stream srcStream, string path)
        {
            ...
            try
            {
                using (dstStream = Open(path, FileMode.Create, FileAccess.Write, FileShare.Read))
                {
                    int len;
            ...
            return (result && Exists(path));
        }

        private Stream Open(string path, FileMode create, FileAccess write, FileShare read)
        {
