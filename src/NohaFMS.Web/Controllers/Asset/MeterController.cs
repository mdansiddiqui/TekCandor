...
namespace NohaFMS.Web.Controllers.Asset
{
    public class MeterController : BaseController
    {
        ...
        public ActionResult List(DataSourceRequest command, string searchValues, IEnumerable<Sort> sort = null)
        {
            ...
            //UserActivityLog
            _meterService.AssetActivityFlowlog(_workContext.CurrentUser.Id, "User[" + _workContext.CurrentUser.Name + "] Asset Meter List");
