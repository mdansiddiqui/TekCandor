...
namespace NohaFMS.Web.Controllers
{
    public class LocationController : BaseController
    {
        ...
        public LocationController(IRepository<Location> locationRepository,
            ...
            IRepository<NohaFMS.Core.Domain.Asset> assetRepository,
        ...
        public ActionResult List(DataSourceRequest command, string searchValues, IEnumerable<Sort> sort = null)
        {
            ...
            //UserActivityLog
            _locationService.AssetActivityFlowlog(_workContext.CurrentUser.Id, "User[" + _workContext.CurrentUser.Name + "] Asset Branch List");
            ...
            if (ModelState.IsValid)
            {
                ...
                PagedResult<Location> data = _locationService.GetLocations(model.ToExpression(), model.ToParameters(), command.Page - 1, command.PageSize, sort);
