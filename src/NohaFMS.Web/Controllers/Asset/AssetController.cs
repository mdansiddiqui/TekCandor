...
namespace NohaFMS.Web.Controllers
{
    public class AssetController : BaseController
    {
        ...
        private readonly IRepository<NohaFMS.Core.Domain.Asset> _assetRepository;
        ...
        public AssetController(IRepository<NohaFMS.Core.Domain.Asset> assetRepository,
        ...
        {
            //UserActivityLog
            _assetService.AssetActivityFlowlog(_workContext.CurrentUser.Id, "User[" + _workContext.CurrentUser.Name + "] Asset ATM List");
            ...
            if (ModelState.IsValid)
            {
                ...
                PagedResult<NohaFMS.Core.Domain.Asset> data = _assetService.GetAssets(model.ToExpression(this._workContext.CurrentUser.Id), model.ToParameters(), command.Page - 1, command.PageSize, sort);
        ...
        {
            var asset = new NohaFMS.Core.Domain.Asset { IsNew = true };
        ...
        {
            this._dbContext.DeleteById<NohaFMS.Core.Domain.Asset>(id);
        ...
        public ActionResult Edit(AssetModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(asset.AssetStatusId != null && model.AssetStatusId != asset.AssetStatusId)
                {
                ...
                if(asset.LocationId != null && model.LocationId != asset.LocationId)
                {
        ...
        {
            var assets = new List<NohaFMS.Core.Domain.Asset>();
