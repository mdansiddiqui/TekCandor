...
namespace NohaFMS.Web.Controllers
{
    public class AuditTrailController : BaseController
    {
        ...
        public ActionResult AuditProperties(long auditTrailId, DataSourceRequest command, IEnumerable<Sort> sort = null)
        {
            ...
            foreach (var auditEntity in auditEntities)
            {
                ...
                foreach (var property in properties)
                {
                    ...
                    {
                        model.Original = property.Original != null ? GetString((byte[])property.Original) : "";
                        model.Current = property.Current != null ? GetString((byte[])property.Current) : "";
                    }
                    else
                    {
        ...
        private string GetString(byte[] original)
        {
