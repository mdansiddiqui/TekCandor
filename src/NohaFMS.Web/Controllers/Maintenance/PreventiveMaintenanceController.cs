...
namespace NohaFMS.Web.Controllers
{
    public class PreventiveMaintenanceController : BaseController
    {
        ...
        {
            //UserActivitylog
            _preventiveMaintenanceService.MaintenanceActivityFlowlog(_workContext.CurrentUser.Id,"User["+_workContext.CurrentUser.Name+ "] Maintenance Preventive-Maintenance List");
            _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl,"Preventive Maintenance");
