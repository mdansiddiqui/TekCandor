...
namespace NohaFMS.Web.Controllers
{
    public class ServiceRequestController : BaseController
    {
        ...
        {
            //UserActivityLog
            _serviceRequestService.MaintenanceActivityFlowlog(_workContext.CurrentUser.Id, "User[" + _workContext.CurrentUser.Name + "] Maintenance Service-Request List");
            _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl,"Service Request");
            var model = _httpContext.Session[SessionKey.ServiceRequestSearchModel] as SearchModel;
            if (model == null)
                model = BuildSearchModel();
            else
