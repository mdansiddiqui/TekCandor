...
namespace NohaFMS.Web.Controllers
{
    public class WorkOrderController : BaseController
    {
        ...
        {
            //userActivityLog
            _workOrderService.MaintenanceActivityFlowlog(_workContext.CurrentUser.Id, "User[" + _workContext.CurrentUser.Name + "] Maintenance Work-Order List");
            _userActivityService.InsertActivityLog("UrlAccessed", _httpContext.Request.RawUrl,"Work Order");
        ...
        public ActionResult Edit(WorkOrderModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    string number = _autoNumberService.GenerateNextAutoNumber(_dateTimeHelper.ConvertToUserTime(DateTime.Now, DateTimeKind.Local), workOrder);
