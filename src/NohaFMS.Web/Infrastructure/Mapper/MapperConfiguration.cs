...
namespace NohaFMS.Web.Infrastructure.Mapper
{
    public class MapperConfiguration : IMapperConfiguration
    {
        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                //ChequeDeposit
                cfg.CreateMap<ChequeDepositInformation, ChequeDepositModel>();
                cfg.CreateMap<ChequeDepositModel, ChequeDepositInformation>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //PasswordPolicy
                cfg.CreateMap<PasswordPolicy, PasswordPolicyModel>();
                cfg.CreateMap<PasswordPolicyModel, PasswordPolicy>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //Hub
                cfg.CreateMap<Hub, HubModel>();
                cfg.CreateMap<HubModel, Hub>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                //Cycle
                cfg.CreateMap<Cycle, CycleModel>();
                cfg.CreateMap<CycleModel, Cycle>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                cfg.CreateMap<BranchModel, Branch>()
                    ...
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                //ReturnReason
                cfg.CreateMap<ReturnReason, ReturnReasonModel>();
               // .ForMember(dest => dest.HubName, opt => opt.MapFrom(src => src.Hub.Name));
                cfg.CreateMap<ReturnReasonModel, ReturnReason>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
