...
BaseEam.Grid = function () {
    ...
    //var SaveCallbackRecord = function (parentId, selectedIds, actionUrl, gridToRefresh, redirectUrl, confirmation) {
    //    debugger
    ...
    //            $.when(kendo.ui.ExtOkCancelDialog.show({
    //                title: "WARNING!",
    //                message: 'Are you sure you want to Call Back this Record?',
    //                icon: 'k-ext-warning'
    //            })).done(function (response) {
    //                if (response.button == "OK") {
    //                    var postData = {
    ...
    var ExportSelectedRows = function (parentId, selectedIds, actionUrl, gridToRefresh, redirectUrl, confirmation) {
        if (selectedIds.length == 0) {
            $.when(kendo.ui.ExtAlertDialog.show({
                title: "ALERT!",
            ...
            if (confirmation == true) {
                $.when(kendo.ui.ExtOkCancelDialog.show({
                    title: "WARNING!",
                    message: 'Are you sure you want to Export this Records?',
                    icon: 'k-ext-warning'
                })).done(function (response) {
                    if (response.button == "OK") {
                        var postData = {
    ...
    var SendEmailSelectedRows = function (selectedIds, actionUrl, gridToRefresh, redirectUrl, confirmation) {
        if (selectedIds.length == 0) {
            $.when(kendo.ui.ExtAlertDialog.show({
                title: "ALERT!",
                message: 'Please Select Record!',
            ...
            if (confirmation == true) {
                $.when(kendo.ui.ExtOkCancelDialog.show({
                    title: "WARNING!",
                    message: 'Are you sure you want to Send this Records?',
                    icon: 'k-ext-warning'
                })).done(function (response) {
                    if (response.button == "OK") {
                        var postData = {
    ...
    var ImportFileRecord = function (actionUrl, gridToRefresh, redirectUrl, confirmation) {
        //if (selectedIds.length == 0)
        //{
        //    $.when(kendo.ui.ExtAlertDialog.show({
        //        title: "ALERT!",
        ...
        if (confirmation == true) {
            $.when(kendo.ui.ExtOkCancelDialog.show({
                title: "WARNING!",
                message: 'Are you sure you want to Import Records?',
                icon: 'k-ext-warning'
            })).done(function (response) {
                if (response.button == "OK") {
                    var selectedIds = 1;
    ...
    return {
        ...
        ImportFileRecord: ImportFileRecord,
        SendEmailSelectedRows: SendEmailSelectedRows
