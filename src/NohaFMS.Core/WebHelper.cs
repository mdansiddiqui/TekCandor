    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new NohaFMSException("NohaFMS needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["NohaFMS.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["NohaFMS.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["NohaFMS.IsPOSTBeingDone"] = value;
            }
        }
