...
namespace NohaFMS.Core.Configuration
{
    /// <summary>
    /// Represents a NohaFMSConfig
    /// </summary>
    public partial class NohaFMSConfig : IConfigurationSectionHandler
    {
        /// <summary>
