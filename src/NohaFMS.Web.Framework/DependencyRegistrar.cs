...
using NohaFMS.Core.Fakes;
using NohaFMS.Data;
using NohaFMS.Services;
using NohaFMS.Web.Framework.UI;
using System.Configuration;
using NohaFMS.Services.Pdf;
using NohaFMS.Services.City;
...
namespace NohaFMS.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            //data layer
            string dataConnectionString = ConfigurationManager.ConnectionStrings["NohaFMS"].ConnectionString;
            builder.Register<IDbContext>(c => new NohaFMSObjectContext("NohaFMS"))
            ...
            //services
            builder.RegisterType<CycleService>().As<ICycleService>().InstancePerLifetimeScope();
            builder.RegisterType<BranchService>().As<IBranchService>().InstancePerLifetimeScope();
            builder.RegisterType<ReturnReasonService>().As<IReturnReasonService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ChequeDepositService>().As<IChequeDepositServices>().InstancePerLifetimeScope();
            builder.RegisterType<LiveMonitoringServices>().As<ILiveMonitoringServices>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<LiveMonitoringServices>().As<LiveMonitoringServices>().InstancePerLifetimeScope();
