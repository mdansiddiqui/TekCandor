...
namespace NohaFMS.Services
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// {0} : language Id
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "NohaFMS.lsr.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// {1} : resource key
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "NohaFMS.lsr.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "NohaFMS.lsr.";
        ...
        public LocalizationService(ICacheManager cacheManager,
            ...
            ILanguageService languageService, IDbContext dbContext,
        ...
        public virtual void DeleteLocaleStringResource(LocaleStringResource localeStringResource)
        {
            ...
            _lsrRepository.DeleteAndCommit(localeStringResource);
        ...
        public virtual void UpdateLocaleStringResource(LocaleStringResource localeStringResource)
        {
            ...
            _lsrRepository.UpdateAndCommit(localeStringResource);
        ...
        public virtual Dictionary<string, KeyValuePair<long, string>> GetAllResourceValues(long languageId)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                {
                    var resourceName = locale.ResourceName;
