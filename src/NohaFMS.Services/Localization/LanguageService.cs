...
namespace NohaFMS.Services
{
    ...
    public partial class LanguageService : BaseService, ILanguageService
    {
        ...
        /// {0} : language Id
        /// </remarks>
        private const string LANGUAGES_BY_ID_KEY = "NohaFMS.language.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        private const string LANGUAGES_ALL_KEY = "NohaFMS.language.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LANGUAGES_PATTERN_KEY = "NohaFMS.language.";
