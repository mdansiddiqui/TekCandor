...
namespace NohaFMS.Services
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        public virtual DateTime? Convert(DateTime? date, string fromTimeZoneId, string toTimeZoneId)
        {
            if (!date.HasValue)
            {
                return null;
        ...
        public virtual DateTime? ConvertFromUtc(DateTime? date, string toTimeZoneId)
        {
        ...
        {
            var timeZoneInfo = GetSystemTimeZones().Where(t => t.Id == user.TimeZoneId).First();
            return timeZoneInfo;
        }
