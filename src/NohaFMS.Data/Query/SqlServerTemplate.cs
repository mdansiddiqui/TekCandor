...
{
    public static class SqlServerTemplate
    {
        ...
        public static readonly string ReturnSearch =
            "SELECT DISTINCT Return.Id, Return.Number, Return.Description, Return.ReturnDate, Return.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name FROM Store" +
        ...
        public static readonly string ReturnSearchCount =
            "SELECT COUNT(DISTINCT Return.Id, Return.Number, Return.Description, Return.ReturnDate, Return.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name) FROM Store" +
            " INNER JOIN Store ON Store.Id = Return.StoreId" +
            " INNER JOIN Site ON Return.SiteId = Site.Id" +
            " INNER JOIN Site_SecurityGroup ON Site.Id = Site_SecurityGroup.SiteId" +
            " INNER JOIN SecurityGroup_User ON Site_SecurityGroup.SecurityGroupId = SecurityGroup_User.SecurityGroupId" +
        ...
        public static readonly string IssueSearch =
            "SELECT DISTINCT Issue.Id, Issue.Number, Issue.Description, Issue.IssueDate, Issue.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name FROM Store" +
        ...
        public static readonly string IssueSearchCount =
            "SELECT COUNT(DISTINCT Issue.Id, Issue.Number, Issue.Description, Issue.IssueDate, Issue.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name) FROM Store" +
            " INNER JOIN Store ON Store.Id = Issue.StoreId" +
            " INNER JOIN Site ON Issue.SiteId = Site.Id" +
            " INNER JOIN Site_SecurityGroup ON Site.Id = Site_SecurityGroup.SiteId" +
            " INNER JOIN SecurityGroup_User ON Site_SecurityGroup.SecurityGroupId = SecurityGroup_User.SecurityGroupId" +
        ...
        public static readonly string TechnicianSearchCount =
           "SELECT COUNT(1) FROM Technician" +
           " INNER JOIN User ON Technician.UserId = User.Id" +
           " LEFT JOIN Team_Technician ON Technician.Id = Team_Technician.TechnicianId" +
           " LEFT JOIN Team ON Team.Id = Team_Technician.TeamId" +
           " INNER JOIN Calendar ON Technician.CalendarId = Calendar.Id" +
        ...
        public static readonly string ReceiptSearch =
            "SELECT DISTINCT Receipt.Id, Receipt.Number, Receipt.Description, Receipt.ReceiptDate, Receipt.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name FROM Store" +
        ...
        public static readonly string ReceiptSearchCount =
            "SELECT COUNT(DISTINCT Receipt.Id, Receipt.Number, Receipt.Description, Receipt.ReceiptDate, Receipt.IsApproved, Site.Id, Site.Name, Store.Id, Store.Name) FROM Store" +
            " INNER JOIN Store ON Store.Id = Receipt.StoreId" +
            " INNER JOIN Site ON Receipt.SiteId = Site.Id" +
            " INNER JOIN Site_SecurityGroup ON Site.Id = Site_SecurityGroup.SiteId" +
            " INNER JOIN SecurityGroup_User ON Site_SecurityGroup.SecurityGroupId = SecurityGroup_User.SecurityGroupId" +
        ...
        public static readonly string ItemCount =
            ...
            " /**where**/" +
            ActiveCondition("Item", "ItemGroup", "UnitOfMeasure");
        public static readonly string ChequeDepositSearch =
         "SELECT * FROM ChequeDepositInformation" +

         " /**where**/" +
         ActiveCondition("ChequeDepositInformation") +
         " /**orderby**/" +
         " OFFSET @skip ROWS FETCH NEXT @take ROWS ONLY";
        public static readonly string ChequeDepositCount =
            "SELECT COUNT(1) FROM ChequeDepositInformation  " +
            " /**where**/ " +
            ActiveCondition("ChequeDepositInformation");
        public static readonly string ChequeDepositCallBackSearch =
             "SELECT * FROM ChequeDepositInformation" +
             ...
             " /**orderby**/" +
             " OFFSET @skip ROWS FETCH NEXT @take ROWS ONLY";
        public static readonly string ChequeDepositCallBackCount =
            "SELECT COUNT(1) FROM ChequeDepositInformation" +
            " /**where**/" +
            ActiveCondition("ChequeDepositInformation");
        public static readonly string LimitSearch =
         "select sg.UpperLimit from [User] U, SecurityGroup SG, SecurityGroup_User SGU where U.Id=SGU.UserId and sg.Id=sgu.SecurityGroupId and U.Id ={0}";
        public static readonly string BranchSearch =
        "SELECT Branch.Code,Branch.[Name] FROM Branch INNER JOIN [User] ON Branch.Id = [User].BranchIds where[User].Id= {0}";
        public static readonly string InstrumentSearch =
        "SELECT Instruments.Code,Instruments.[Name] FROM Instruments INNER JOIN ChequeDepositInformation ON Instruments.code= ChequeDepositInformation.InstrumentNo where  InstrumentNo = {0}";
        public static readonly string hubSearch =
        "SELECT Hub.Id,Hub.Code,Hub.Name FROM Hub INNER JOIN Branch ON Hub.Id = Branch.HubId where Branch.Code = {0};";
        ...
        public static readonly string LiveMonitoringSearch =
         "SELECT * FROM LiveMonitoring" +

         " /**where**/" +
         ActiveCondition("LiveMonitoring") +
         " /**orderby**/" +
         " OFFSET @skip ROWS FETCH NEXT @take ROWS ONLY";

        public static readonly string LiveMonitoringCount =
            "SELECT COUNT(1) FROM LiveMonitoring  " +
