...
namespace NohaFMS.Data
{
    public static class SqlTemplate
    {
        ...
        public static string ReaturnReasonSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "ReturnReason");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "ReturnReason");
        ...
        public static string CitySearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "City");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "City");

            return template;
        }

        public static string CitySearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "City");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "City");
        ...
        public static string MyReportSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "MyReport");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "MyReport");

            return template;
        }

        public static string MyReportSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "MyReport");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "MyReport");
        ...
        public static string LiveMonitoringSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.LiveMonitoringSearch;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.LiveMonitoringSearch;

            return template;
        }

        public static string LiveMonitoringSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.LiveMonitoringCount;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.LiveMonitoringCount;
        ...
        #region CheqeDeposit
        public static string CheqeDepositSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.ChequeDepositSearch;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.ChequeDepositSearch;

            return template;
        }

        public static string ChequeDepositSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.ChequeDepositCount;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.ChequeDepositCount;

            return template;
        }
        public static string CheqeDepositCallBackSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.ChequeDepositCallBackSearch;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.ChequeDepositSearch;
        ...
        public static string ChequeDepositCallBackSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = SqlServerTemplate.ChequeDepositCallBackCount;
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = MySqlTemplate.ChequeDepositCount;

            return template;
        }
        public static string LimitSearch(long id)
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.LimitSearch, id);
            return template;
        }
        public static string BranchSearch(long id)
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.BranchSearch, id);
            return template;
        }
        public static string InstrumentNumberSearch(string code)
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.InstrumentSearch, code);
            return template;
        }
        public static string hubSearch(string id)
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.hubSearch, id);
            return template;
        }
        ...
        #region HUB
        public static string HubSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "Hub");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "Hub");

            return template;
        }

        public static string HubSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "Hub");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "Hub");
        ...
        public static string BranchSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "Branch");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "Branch");

            return template;
        }

        public static string BranchSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "Branch");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "Branch");

            return template;
        } 
        #endregion 
        #region ReturnReason
        public static string ReturnReasonSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "ReturnReason");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "ReturnReason'");

            return template;
        }
        public static string ReturnReasonSearch(long id)
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.ReturnSearch, id);
            return template;
        }
        public static string ReturnReasonSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "ReturnReason");
        ...
        #region Cycle
        public static string CycleSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "Cycle");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "Cycle");

            return template;
        }

        public static string CycleSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "Cycle");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "Cycle");
        ...
        public static string PasswordPolicySearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "PasswordPolicy");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "PasswordPolicy");

            return template;
        }

        public static string PasswordPolicySearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "PasswordPolicy");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "PasswordPolicy");
        ...
        #region Bank
        public static string BankSearch()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonSearch, "Bank");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonSearch, "Bank");

            return template;
        }

        public static string BankSearchCount()
        {
            string template = "";
            if (DataSettings.DataProvider == "System.Data.SqlClient")
                template = string.Format(SqlServerTemplate.CommonCount, "Bank");
            else if (DataSettings.DataProvider == "MySql.Data.MySqlClient")
                template = string.Format(MySqlTemplate.CommonCount, "Bank");
