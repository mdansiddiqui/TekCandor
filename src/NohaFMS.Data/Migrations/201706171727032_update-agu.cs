...
namespace NohaFMS.Data.Migrations
{
    ...
    public partial class updateagu : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.AssignmentGroupUser_Site", "SiteId", "dbo.Site", "Id", cascadeDelete: false);
            AddForeignKey("dbo.AssignmentGroupUser_Site", "AssignmentGroupUserId", "dbo.AssignmentGroupUser", "Id", cascadeDelete: false);
        }
    }
}
