namespace NohaFMS.Data.Migrations
{
    ...
    public partial class removeusergroup : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.UserGroup_User", "UserId", "dbo.User", "Id", cascadeDelete: false);
            AddForeignKey("dbo.UserGroup_User", "UserGroupId", "dbo.UserGroup", "Id", cascadeDelete: false);
        }
    }
}
