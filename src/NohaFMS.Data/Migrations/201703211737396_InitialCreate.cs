    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .Index(t => t.FeatureId);
            //Sql("CREATE index 'IX_FeatureId' on 'FeatureAction' ('FeatureId' DESC)");
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Module", t => t.ModuleId, cascadeDelete: false)
                .Index(t => t.ModuleId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ActivityLogType", t => t.ActivityLogTypeId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Feature", t => t.FeatureId, cascadeDelete: false)
                .ForeignKey("dbo.FeatureAction", t => t.FeatureActionId, cascadeDelete: false)
                .ForeignKey("dbo.Module", t => t.ModuleId, cascadeDelete: false)
                .Index(t => t.ModuleId)
                .Index(t => t.FeatureId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PermissionRecord", t => t.SecurityGroupId, cascadeDelete: false)
                .ForeignKey("dbo.SecurityGroup", t => t.PermissionRecordId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.SecurityGroup", t => t.SecurityGroupId, cascadeDelete: false)
                .Index(t => t.SiteId)
                .Index(t => t.SecurityGroupId);
