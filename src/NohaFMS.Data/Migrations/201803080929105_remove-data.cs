namespace NohaFMS.Data.Migrations
{
    ...
    public partial class removedata : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.RequestForQuotation", "AssignmentId", "dbo.Assignment", "Id", cascadeDelete: false);
            ...
            AddForeignKey("dbo.PurchaseOrder", "AssignmentId", "dbo.Assignment", "Id", cascadeDelete: false);
            ...
            AddForeignKey("dbo.TenantLease", "AssignmentId", "dbo.Assignment", "Id", cascadeDelete: false);
            ...
            AddForeignKey("dbo.PurchaseRequest", "AssignmentId", "dbo.Assignment", "Id", cascadeDelete: false);
        }
    }
}
