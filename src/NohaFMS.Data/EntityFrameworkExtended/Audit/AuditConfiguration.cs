...
namespace EntityFramework.Audit
{
    ...
    public class AuditConfiguration
    {
        ...
        /// <summary>
        /// @NohaFMS: Use this method to not use AuditAttribute on BaseEntity class
        /// </summary>
        /// <param name="entityType"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        internal bool IsAuditable(Type entityType, bool value)
        {
            return DefaultAuditable || _auditableCache.GetOrAdd(entityType, key => value);
        }
        ...
        /// <summary>
        /// @NohaFMS: Use this method to not use NotAuditedAttribute on properties of BaseEntity class
        /// </summary>
        /// <param name="entityType"></param>
        /// <param name="name"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        internal bool IsNotAudited(Type entityType, string name, bool value)
        {
            string fullName = entityType.FullName + "." + name;
            return DefaultAuditable || _notAuditedCache.GetOrAdd(fullName, key => value);
        }
